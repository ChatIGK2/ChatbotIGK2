...
const responses = {
    it: {
        cos_e_igk2: "<div style='margin-bottom: 20px'><span style='color: #007bff'>IGK2</span> utilizza una rivoluzionaria nanotecnologia a base di silicio. Le molecole di silicio di dimensioni nanometriche penetrano e riempiono anche le più piccole fessure nelle superfici delle pareti, creando una barriera termica altamente efficace.</div>\
...
1. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>Come si applica <span style='color: #007bff'>IGK2</span>?</a><br>\
...
5. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>Come funziona la nanotecnologia?</a>\
        ...
        spessore: "<div style='margin-bottom: 20px'>\
...
5. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>Si può applicare su pareti già dipinte?</a>\
        ...
        vantaggi: "Ecco un confronto tra <span style='color: #007bff'>IGK2</span> e il rivestimento tradizionale:\n\n1) Spessore:\n   ✅ IGK2: Solo 4-8 mm\n   ❌ Tradizionale: 8-12 cm\n\n2) Isolamento Termico:\n   ✅ IGK2: Lambda 0,0019 W/mK\n   ❌ Tradizionale: Lambda 0,035-0,040 W/mK\n\n3) Applicazione:\n   ✅ IGK2: Veloce, come normale rivestimento armato\n   ❌ Tradizionale: Complessa, richiede tasselli\n\n4) Traspirabilità:\n   ✅ IGK2: Altamente traspirante\n   ❌ Tradizionale: Può creare condensa",
        default: "Mi dispiace, non ho capito la tua domanda. Potresti riformularla in modo diverso?"
    },
    en: {
        cos_e_igk2: "<div style='margin-bottom: 20px'><span style='color: #007bff'>IGK2</span> uses revolutionary silicon-based nanotechnology. Silicon molecules of nanometric size penetrate and fill even the smallest cracks in wall surfaces, creating a highly effective thermal barrier.</div>\
...
<div style='margin-left: 20px'>\
1. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>How is <span style='color: #007bff'>IGK2</span> applied?</a><br>\
...
5. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>Can it be applied to already painted walls?</a>\
        ...
        vantaggi: "Here's a comparison between <span style='color: #007bff'>IGK2</span> and traditional coating:\n\n1) Thickness:\n   ✅ IGK2: Only 4-8 mm\n   ❌ Traditional: 8-12 cm\n\n2) Thermal Insulation:\n   ✅ IGK2: Lambda 0.0019 W/mK\n   ❌ Traditional: Lambda 0.035-0.040 W/mK\n\n3) Application:\n   ✅ IGK2: Quick, like normal reinforced coating\n   ❌ Traditional: Complex, requires dowels\n\n4) Breathability:\n   ✅ IGK2: Highly breathable\n   ❌ Traditional: Can create condensation",
        default: "I'm sorry, I didn't understand your question. Could you rephrase it?"
    },
    de: {
        cos_e_igk2: "<div style='margin-bottom: 20px'><span style='color: #007bff'>IGK2</span> verwendet revolutionäre Silizium-basierte Nanotechnologie. Siliziummoleküle von nanometrischer Größe dringen in die kleinsten Risse in der Wand ein und schaffen eine hochwirksame Wärmebarriere.</div>\
...
<div style='margin-left: 20px'>\
1. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>Wie wird <span style='color: #007bff'>IGK2</span> aufgetragen?</a><br>\
...
5. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>Kann es auf bereits gestrichene Wände aufgetragen werden?</a>\
        ...
        vantaggi: "Hier ist ein Vergleich zwischen <span style='color: #007bff'>IGK2</span> und traditioneller Beschichtung:\n\n1) Dicke:\n   ✅ IGK2: Nur 4-8 mm\n   ❌ Traditionell: 8-12 cm\n\n2) Wärmeisolierung:\n   ✅ IGK2: Lambda 0,0019 W/mK\n   ❌ Traditionell: Lambda 0,035-0,040 W/mK\n\n3) Anwendung:\n   ✅ IGK2: Schnell, wie normale verstärkte Beschichtung\n   ❌ Traditionell: Komplex, erfordert Dübel\n\n4) Atmungsaktivität:\n   ✅ IGK2: Hoch atmungsaktiv\n   ❌ Traditionell: Kann Kondenswasser bilden",
        default: "Es tut mir leid, ich habe Ihre Frage nicht verstanden. Könnten Sie sie anders formulieren?"
    },
    es: {
        cos_e_igk2: "<div style='margin-bottom: 20px'><span style='color: #007bff'>IGK2</span> utiliza una revolucionaria nanotecnología a base de silicio. Las moléculas de silicio de tamaño nanométrico penetran y llenan incluso las grietas más pequeñas en las superficies de las paredes, creando una barrera térmica altamente eficaz.</div>\
...
<div style='margin-left: 20px'>\
1. <a href='#' onclick='return false;' style='color: #007bff; text-decoration: none;'>¿Cómo se aplica <span style='color: #007bff'>IGK2</span>?</a><br>\
...
\
<div style='margin-bottom: 20px'>\
Para ver la correcta aplicación, consulta nuestros <span style='color: #dc3545'>Videos Explicativos del Producto</span> que muestran el proceso paso a paso.\
</div>\
\
<div style='margin-bottom: 15px'>\
...
function findBestResponse(userInput) {
    ...
    const keywordMap = {
        'cos_e_igk2': ['cos è igk2', 'cosa è igk2', 'che cosa è igk2', 'che cos è igk2'],
        'spessore': ['quanto spesso', 'spessore', 'quanto è spesso', 'spesso è'],
        'vantaggi': ['vantaggi', 'vantaggio', 'benefici', 'beneficio', 'meglio', 'differenza', 'confronto']
    };
